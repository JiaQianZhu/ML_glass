...
Author: JiaQian Zhu
Date: 2023-8-17
Usage: This module offers a method to train and test on the original dataset (filled) with CART.
"""
...
cart_model.fit(train_features, train_targets)

# Predict on the validation set.
val_predictions = cart_model.predict(val_features)
...
with open('../model/joint_prediction/cart_model.pickle', 'wb') as file:
