...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to filter out the non-missing portions of Young's Modulus and conduct training using the RF algorithm with LOOCV.
"""
...
with open('../model/individual_prediction/YoungModulus_rf_model.pickle', 'wb') as file:
