...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to generate the scatter density plot of Tsoft.
"""
...
scatter = ax.scatter(y_test, y_test_pred, c=y_test - y_test_pred, cmap='cool', s=0.055 * (np.abs(y_test - y_test_pred)))

# Add a colorbar.
cbar = plt.colorbar(scatter, ax=ax)
cbar.set_label('Tsoft', weight='bold', fontsize=16)
...
# Set the axis labels.
ax.set_ylabel('Predicted Values of Tsoft', fontsize=16, fontweight='bold')
...
ax_inset1.hist(y_test - y_test_pred, bins=1500, color='blue', alpha=0.8)
...
ax_inset1.get_yticklabels()[-3].set_weight('bold')
