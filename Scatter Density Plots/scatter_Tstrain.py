...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to generate the scatter density plot of Tstrain.
"""
...
scatter = ax.scatter(y_test, y_test_pred, c=y_test - y_test_pred, cmap='cool', s=0.25 * (np.abs(y_test - y_test_pred)))

# Add a colorbar.
cbar = plt.colorbar(scatter, ax=ax)
cbar.set_label('Tstrain', fontsize=16, weight='bold')
...
# Set the axis labels.
ax.set_ylabel('Predicted Values of Tstrain', fontweight='bold', fontsize=16)
ax.set_xlabel('Reported Values', fontweight='bold', fontsize=16)
