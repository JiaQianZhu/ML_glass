...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to generate the shap plots of density.
"""
...
column_index_Density293K = list(y_val.columns).index('Density293K')
shap_values_Density293K = shap_values[column_index_Density293K]

# Plot the SHAP summary plot for 'Density293K'
shap.summary_plot(shap_values_Density293K, X_val, feature_names=X_val.columns, show=False)
plt.title("SHAP on Density", fontweight='bold', fontsize=18)
plt.subplots_adjust(top=0.9)
plt.xticks(fontweight='bold')
plt.yticks(fontweight='bold')  
plt.savefig("../results/shap/density.jpg", dpi=300)
