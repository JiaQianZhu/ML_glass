...
Author:JiaQian Zhu
Date:2023-8-17
Usage:This module offers method to generate the shap plots of Tsoft.
"""
...
column_index_Tsoft = list(y_val.columns).index('Tsoft')
shap_values_Tsoft = shap_values[column_index_Tsoft]

# Plot the SHAP summary plot for 'Tsoft'.
shap.summary_plot(shap_values_Tsoft, X_val, feature_names=X_val.columns, show=False)
plt.title("SHAP on Tsoft", fontweight='bold', fontsize=18)
plt.subplots_adjust(top=0.9)
plt.xticks(fontweight='bold')
plt.yticks(fontweight='bold')
plt.savefig("../results/shap/Tsoft.jpg", dpi=300)
